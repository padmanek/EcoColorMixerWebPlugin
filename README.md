...
- `Server/Mods/UserCode/EcoColorMixerWeb/index.html`

## Install
Copy the `Server/Mods/UserCode/EcoColorMixerWeb` folder into your Eco server's `Server/Mods/UserCode` directory and restart the server.
